// Question: https://codeforces.com/contest/1443/problem/C
// Solution: https://codeforces.com/contest/1443/submission/97489457
...
int main(){
    ...
    tests{
        ...
        for(ll int i=n-2;i>=0;i--){
            l += v[i+1].second;
            tim = min(tim, max(v[i].first, l) );
        }
        
        tim  = min(tim, accumulate(BB, BB+n, 0LL));
        cout<<tim; NL
    }
