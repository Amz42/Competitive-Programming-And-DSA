// Question: https://codeforces.com/contest/1401/problem/C
// Solution: https://codeforces.com/contest/1401/submission/91304212
...
int main(){
    ...
    tests{
        ...
        int arr[n], v[n];
        fori(n) cin>>arr[i], mn = min(mn,arr[i]), v[i]=arr[i];
        ...
        sort(v,v+n);
        bool yes = true;
        fori(n) if(v[i]!=arr[i] && arr[i]%mn){ yes=false; break;}
        if(yes) cout<<"YES";
        else cout<<"NO";
        NL
    }
