// Question: https://codeforces.com/contest/1407/problem/A
// Solution: https://codeforces.com/contest/1407/submission/92297595
    ...
    tests{
        ...
        fori(n){
            ...
            if(x==0){
                ...
                if(last==1) ans.pb(1), ans.pb(1), last=0;
                else last++;
            }
        }
