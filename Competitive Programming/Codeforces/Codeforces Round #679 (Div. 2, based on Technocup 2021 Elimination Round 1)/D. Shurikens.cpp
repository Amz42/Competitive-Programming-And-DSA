// Question: https://codeforces.com/contest/1435/problem/D
// Solution: https://codeforces.com/contest/1435/submission/96782106
...
int main(){
    ...
    while(!v.empty()){
        int tope = v.top(); v.pop();
        // cout<<tope;
        if(tope){ // - x
            if(!st.empty() && st.top() < tope){cout<<"NO"; return 0;}
            st.push(tope);
        }else{ // +
