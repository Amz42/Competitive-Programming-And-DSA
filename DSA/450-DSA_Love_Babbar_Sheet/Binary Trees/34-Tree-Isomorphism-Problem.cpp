...
int main(){
    int t; scanf("%d ",&t); while(t--){
		...
		if(isIsomorphic(root1,root2)) cout<<"Yes"<<endl;
		else cout<<"No"<<endl;
    }
    return 0;
}
...
bool isIsomorphic(Node *root1,Node *root2){
    if(root1 == NULL && root2 == NULL) return true; // dono hi NULL hai
    if(root1 == NULL || root2 == NULL) return false; // dono mein se 1 NULL hai
    if(root1->data != root2->data) return false; // data match nahi kr rha
